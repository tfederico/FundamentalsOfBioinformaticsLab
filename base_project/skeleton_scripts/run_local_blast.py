...
def blast(db, query, evalue, query_folder="./queries/", blast_path="", psiblast=False):
    """
...
def main(uniprot_id_list, query_folder, db, psiblast, output_filename, evalue, output_png=""):
    ...
    print "The script " + __file__ + " ran successfully with an execution time of "+ str(datetime.now()-start_time)
